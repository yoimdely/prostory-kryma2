...
function injectSEO() {
  ...
  const metas = [
    ...
    { property: "og:image", content: "/media/51.jpeg" },
...
function injectFonts() {
  ...
  links.forEach(cfg => { const l = document.createElement("link"); Object.entries(cfg).forEach(([k,v])=>l.setAttribute(k,v)); document.head.appendChild(l); });
}

/* ================= Decorations ================= */
function TopWave() {
  return (
    <svg className="absolute inset-x-0 -top-16 w-full pointer-events-none" viewBox="0 0 1440 180" fill="none" preserveAspectRatio="none">
      <path d="M0 120C180 60 360 60 540 105C720 150 900 150 1080 105C1200 75 1320 60 1440 75V0H0v120Z" fill="#F6E6D9"/>
    </svg>
  );
}
function BottomWave() {
  return (
    <svg className="absolute inset-x-0 -bottom-20 w-full pointer-events-none" viewBox="0 0 1440 200" fill="none" preserveAspectRatio="none">
      <path d="M0 40C220 120 420 140 720 120C1020 100 1230 60 1440 20V200H0V40Z" fill="#FFF3EA"/>
    </svg>
  );
}
function GradientBlob({ className }) {
  return (
    <div
      ...
      style={{
        background: "radial-gradient(50% 50% at 50% 50%, #ffb38a 0%, rgba(255,142,102,0.6) 40%, rgba(255,142,102,0) 70%)"
      }}
    />
  );
}
...
function Stat({ value, label, sub, icon }) {
  return (
    <div className="p-5 rounded-2xl border h-full bg-white/90 backdrop-blur-sm shadow-sm"
...
function IconWrap({ children }) {
  return (
    <div className="w-10 h-10 rounded-xl grid place-items-center border bg-[#FFF8F2]"
         style={{ borderColor: "#EAD6C4", color: "#2B2118" }}>
      {children}
    </div>
  );
...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative"
      ...
      {/* floating decor */}
      <TopWave />
      <GradientBlob className="w-72 h-72 -z-10 top-24 -left-10 animate-pulse" />
      <GradientBlob className="w-96 h-96 -z-10 top-40 right-10 animate-[spin_18s_linear_infinite]" />
        ...
        <div className="max-w-6xl mx-auto px-5 py-3 flex items-center gap-4">
          ...
          <div className="ml-auto hidden sm:flex items-center gap-3">
            <a href="#cta" className="px-4 py-2 rounded-2xl hover:shadow-md"
               style={{ backgroundColor: "#C65D3A", color: "#FFF8F2" }}>Оставить заявку</a>
      ...
      <section className="relative overflow-hidden">
        <div className="relative max-w-6xl mx-auto px-4 py-12 md:py-20 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.5}}>
            {/* короче заголовок в 2 строки, без ломания в 4 */}
            <h1 className="text-[40px] md:text-[56px] leading-[1.05] font-extrabold"
            ...
            <ul className="mt-6 grid grid-cols-2 gap-3 text-sm">
              {[
                ...
                <li key={i} className="p-3 rounded-xl shadow flex items-center gap-2 border bg-white/90 backdrop-blur"
                    style={{borderColor:'#EAD6C4', color:'#2B2118'}}>{icon} {t}</li>
              ))}
            </ul>

            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#cta" className="px-5 py-3 rounded-2xl hover:shadow-lg"
          ...
          >
            <img src={IMG.hero} alt="Визуализация квартала у моря"
                 className="w-full h-full object-cover" loading="eager" fetchpriority="high" />
            {/* декоративная полупрозрачная маска сверху */}
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6 grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div key={i} className="p-5 rounded-2xl border flex items-start gap-3 bg-white/90 backdrop-blur"
          ...
          <div>
            ...
            <ul className="mt-6 grid grid-cols-2 gap-3 text-sm">
              {[{t:"Школы и детские сады", icon:<School size={16}/>},
                ...
                <li key={idx} className="p-3 rounded-xl border flex items-center gap-2 bg-white/90"
                    style={{borderColor:'#EAD6C4', color:'#2B2118'}}>
                  {i.icon} {i.t}
                </li>
              ))}
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl border bg-white/90" style={{borderColor:'#EAD6C4'}}>
          ...
          <div className="p-6 rounded-2xl border shadow bg-white" style={{borderColor:'#EAD6C4'}}>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-3 text-sm" style={{color:'#4B3B30'}}>
              {["Энергоэффективность и комфорт","Ликвидность для аренды/перепродажи","Удобные планировки","Паркинг и коммерция на территории"].map((t,i)=> (
                <div key={i} className="p-4 rounded-xl border bg-[#FFF8F2]" style={{borderColor:'#EAD6C4'}}>{t}</div>
              ))}
            </div>
            <div className="mt-4 grid grid-cols-3 gap-3">
              {[IMG.extra1, IMG.extra2, IMG.extra3].map((s, i)=>(
                <img key={i} src={s} alt="Детали" className="w-full aspect-[4/3] object-cover rounded-xl border" style={{borderColor:'#EAD6C4'}} loading="lazy" />
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="p-5 rounded-2xl border flex items-start gap-3 bg-white/90" style={{borderColor:'#EAD6C4'}}>
                ...
                <div>
                  ...
                  <a href="#cta" className="mt-3 inline-block text-sm hover:underline" style={{color:'#C65D3A'}}>Запросить PDF-подборку планировок</a>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="p-6 rounded-2xl border bg-[#FFF8F2]" style={{borderColor:'#EAD6C4'}}>
            ...
            <div className="grid grid-cols-3 gap-3 mt-3 text-sm" style={{color:'#4B3B30'}}>
              {["Сбер","ВТБ","Дом.РФ","Альфа","Газпромбанк","РНКБ"].map((b,i)=>(
                <div key={i} className="h-14 rounded-xl border grid place-items-center bg-white" style={{borderColor:'#EAD6C4'}}>{b}</div>
              ))}
            </div>
      ...
      <section id="buy" className="py-20 relative">
        <GradientBlob className="w-80 h-80 right-10 -bottom-10 animate-[spin_22s_linear_infinite]"/>
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-4">
            ...
            <a href="#cta" className="inline-block px-5 py-3 rounded-2xl hover:shadow-lg"
               style={{backgroundColor:'#C65D3A', color:'#FFF8F2'}}>Получить подборку</a>
            <a href="https://t.me/todayididg00d" target="_blank" rel="noopener noreferrer"
               className="inline-block px-5 py-3 rounded-2xl border hover:shadow-md ml-2"
              ...
              <>
                ...
                <form onSubmit={onSubmit} className="mt-4 space-y-3">
                  ...
                  <button type="submit" disabled={sending}
                          className="w-full px-4 py-3 rounded-xl hover:shadow-lg disabled:opacity-70"
