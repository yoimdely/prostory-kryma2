...
function injectFonts() {
  ...
  parts.forEach(p => {
    ...
    Object.entries(p).forEach(([k, v]) => v !== undefined && el.setAttribute(k, v));
    document.head.appendChild(el);
  });
}
...
function IconWrap({ children }) {
  return (
    <div className="w-10 h-10 rounded-xl grid place-items-center border shrink-0"
      style={{ borderColor: "#EAD6C4", backgroundColor: "#FFF3EA", color: "#2B2118" }}>
      {children}
    </div>
  );
}

function WaveDecor({ className = "", flip = false }) {
  return (
    <svg className={className} viewBox="0 0 1440 160" preserveAspectRatio="none" style={{ transform: flip ? "scaleY(-1)" : "none" }}>
      <path fill="#FFF3EA" d="M0,64L48,69.3C96,75,192,85,288,96C384,107,480,117,576,106.7C672,96,768,64,864,53.3C960,43,1056,53,1152,80C1248,107,1344,149,1392,170.7L1440,192L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z" />
    </svg>
  );
}
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FFF8F2", color: "#1F1B16", fontFamily: "Montserrat, sans-serif" }}>
        ...
        <div className="max-w-6xl mx-auto px-5 py-3 flex items-center gap-4">
          ...
          <div className="ml-auto hidden sm:flex items-center gap-3">
            ...
            <a href="https://t.me/todayididg00d" target="_blank" rel="noopener noreferrer"
              className="px-4 py-2 rounded-2xl border hover:shadow-md" style={{ borderColor: "#D4A373", color: "#2B2118" }}>
              Написать в TG
            </a>
          </div>
      ...
      <div className="relative">
        <WaveDecor className="w-full h-[90px]" />
      </div>

      {/* HERO */}
      <section className="relative overflow-hidden">
        <div className="absolute -z-10 inset-0 pointer-events-none"
          style={{ background: "radial-gradient(1200px 500px at -10% -10%, #F6E6D9 0%, rgba(246, 230, 217, 0) 60%)" }} />
        <div className="relative max-w-6xl mx-auto px-4 py-12 md:py-16 lg:py-20 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            <h1 className="font-extrabold tracking-tight"
              style={{ fontFamily: "Prata, serif", color: "#2B2118", fontSize: "clamp(32px, 5vw, 56px)", lineHeight: 1.08, maxWidth: 780 }}>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <Chip icon={<WavesIcon size={16} />} text="1,4 км до пляжа" />
              <Chip icon={<Building2 size={16} />} text="6–10 этажей" />
              <Chip icon={<Bath size={16} />} text="Предчистовая / с ремонтом" />
              <Chip icon={<ParkingSquare size={16} />} text="Паркинг: многоуровневый и гостевой" />
            </div>
      ...
      <div className="relative -mt-1">
        <WaveDecor className="w-full h-[70px]" flip />
      </div>

      {/* ABOUT */}
      <section id="about" className="py-14 md:py-20">
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-[1.6fr_.9fr] gap-10">
          <div>
      ...
      <section id="gallery" className="py-14 md:py-20" style={{ backgroundColor: "#FFF3EA" }}>
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            {["/media/2.jpeg", "/media/12.jpeg", "/media/22.jpeg"].map((src, i) => (
      ...
      <section id="location" className="py-14 md:py-20">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="rounded-2xl overflow-hidden shadow border bg-white" style={{ borderColor: "#EAD6C4" }}>
          ...
          <div className="p-6 rounded-2xl border shadow bg-white" style={{ borderColor: "#EAD6C4" }}>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-3 text-sm" style={{ color: "#4B3B30" }}>
              {["Энергоэффективность и комфорт", "Ликвидность для аренды/перепродажи", "Удобные планировки", "Паркинг и коммерция на территории"]
                .map((t, i) => (
                  <div key={i} className="p-4 rounded-xl border bg-[#FFF8F2]"
                    style={{ borderColor: "#EAD6C4" }}>{t}</div>
                ))}
            </div>
          </div>
        </div>
      ...
      <section id="buy" className="py-20">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-4">
            ...
            <a href="#cta" className="inline-block px-5 py-3 rounded-2xl hover:shadow-md"
              style={{ backgroundColor: "#C65D3A", color: "#FFF8F2" }}>Получить подборку</a>
            <a href="https://t.me/todayididg00d" target="_blank" rel="noopener noreferrer"
              className="block md:inline-block px-5 py-3 rounded-2xl border hover:shadow-md"
