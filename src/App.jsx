...
/* ----------------- helpers ----------------- */
// корректная сборка путей для GitHub Pages (/prostory-kryma2/)
const asset = (p) => new URL(p, import.meta.env.BASE_URL).href;

// локальные изображения из public/media
const IMG = {
  hero: asset("media/51.jpeg"),
  g1: asset("media/11.jpeg"),
  g2: asset("media/12.jpeg"),
  g3: asset("media/22.jpeg"),
  extra1: asset("media/2.jpeg"),
  extra2: asset("media/5.jpeg"),
  extra3: asset("media/64.jpeg"),
};
...
function injectSEO() {
  ...
  const meta = [
    ...
    { property: "og:image", content: base + "media/51.jpeg" },
    { property: "og:url", content: typeof location !== "undefined" ? location.href : base }
  ];
  ...
  link.href = typeof location !== "undefined" ? location.href : base;
...
function Stat({ value, label, sub, icon }) {
  return (
    <div
      className="p-5 rounded-2xl border h-full shadow-sm"
    ...
    >
      ...
      >
        <div className="max-w-6xl mx-auto px-5 py-3 flex items-center gap-4">
          <a href="#" className="flex items-center gap-3 shrink-0">
            <div
              className="w-9 h-9 rounded-2xl grid place-items-center font-semibold"
              style={{ backgroundColor: "#2B2118", color: "#F6E6D9" }}
            >ПК</div>
          ...
          <nav className="hidden lg:flex items-center gap-6 text-[13px] mx-auto" aria-label="Главное меню">
            {[
              ...
              <a key={href} href={href} className="hover:text-orange-600 transition-colors" style={{ color: "#4B3B30" }}>
                {t}
              </a>
            ))}
          </nav>
          ...
          <div className="ml-auto hidden sm:flex items-center gap-3">
            <a
              href="#cta"
              className="px-4 py-2 rounded-2xl hover:shadow-md"
              style={{ backgroundColor: "#C65D3A", color: "#FFF8F2" }}
            >
              Подбор квартиры
            </a>
            <a
              href="https://t.me/todayididg00d" target="_blank" rel="noopener noreferrer"
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          style={{ background: "linear-gradient(180deg, #F6E6D9 0%, #FFF8F2 70%)" }}
        />
        <div className="relative max-w-6xl mx-auto px-4 py-14 md:py-20 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            >
              Жилой квартал у моря
              <br />
              <span className="inline-block mt-1">«Просторы&nbsp;Крыма»</span>
            </h1>

            <p className="mt-5 text-base md:text-lg" style={{ color: "#4B3B30", maxWidth: 640 }}>
              Комфорт-класс, монолит-кирпич, высота потолков ~3,02 м, благоустроенные дворы, детские и спортивные
              площадки, торговые галереи и виды на Чёрное море. До моря ≈ 1,4 км. Первая сдача — 1 кв. 2026; очереди — до
              4 кв. 2029.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="#cta"
                className="px-5 py-3 rounded-2xl hover:shadow-md"
                style={{ backgroundColor: "#C65D3A", color: "#FFF8F2" }}
              >
                Получить подборку
              </a>
              <a
                href="https://t.me/todayididg00d"
                target="_blank"
          ...
          >
            <img
              ...
              height={1040}
            />
            {/* легкая волна поверх картинки */}
            <div className="absolute -bottom-1 left-0 right-0 opacity-80 pointer-events-none">
              <WaveBottom />
            </div>
          </motion.div>
        </div>
      ...
      <section id="about" className="py-14 md:py-20">
        <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2">
            <h2 className="text-2xl md:text-3xl font-bold" style={{ fontFamily: "Prata, serif" }}>
              О проекте
            </h2>
            <p className="mt-4" style={{ color: "#4B3B30" }}>
              «Просторы Крыма» — современная квартальная застройка у моря: безопасные дворы без машин, детские и
              спортивные площадки, озеленение и коммерция шаговой доступности. Продуманные планировки и виды на Чёрное
              море.
            </p>
            ...
            <div className="mt-6 grid sm:grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={i}
                  className="p-5 rounded-2xl border flex items-start gap-3 bg-white shadow-sm"
                  style={{ borderColor: "#EAD6C4" }}
                >
                  <IconWrap>{c.icon}</IconWrap>
                  <div>
                    <div className="font-semibold" style={{ color: "#2B2118" }}>
                      {c.h}
                    </div>
                    <div className="text-sm mt-1" style={{ color: "#4B3B30" }}>
                      {c.t}
                    </div>
                  </div>
                </div>
          ...
          <aside className="p-6 rounded-2xl border" style={{ backgroundColor: "#F6E6D9", borderColor: "#EAD6C4" }}>
            ...
            <ul className="mt-3 space-y-2 text-sm" style={{ color: "#4B3B30" }}>
              <li>
                <WavesIcon size={14} className="inline mr-2" /> ≈ 1,4 км до пляжа
              </li>
              <li>
                <MapPin size={14} className="inline mr-2" /> Панорамные виды на море
              </li>
              <li>
                <ParkingSquare size={14} className="inline mr-2" /> Паркинг: многоуровневый + гостевой
              </li>
              <li>
                <Bath size={14} className="inline mr-2" /> Отделка: предчистовая или с ремонтом
              </li>
            </ul>
            <a
              href="#cta"
              className="mt-5 inline-block w-full text-center px-4 py-2 rounded-xl hover:shadow-md"
              style={{ backgroundColor: "#C65D3A", color: "#FFF8F2" }}
            >
              Запросить подборку
            </a>
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-4">
            {[IMG.g1, IMG.g2, IMG.g3].map((src, i) => (
              ...
              >
                <img
                  src={src}
                  alt="Визуализации фасадов/интерьеров"
      ...
      <section id="location" className="py-14 md:py-20">
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="mt-4" style={{ color: "#4B3B30" }}>
              Посёлок Приморский, г.о. Феодосия, Республика Крым. Координаты: 45.138389, 35.509972. До пляжа ≈ 1,4 км.
              Рядом — аллея, спортплощадки, торговые галереи, школы, сады, медцентр.
            </p>
            <ul className="mt-6 grid grid-cols-2 gap-3 text-sm">
              {[
                ...
                <li
                  key={idx}
                  className="p-3 rounded-xl border flex items-center gap-2 bg-white"
                  style={{ borderColor: "#EAD6C4", color: "#2B2118" }}
                >
                  {i.icon} {i.t}
                </li>
          ...
          <div className="rounded-2xl overflow-hidden shadow border relative" style={{ borderColor: "#EAD6C4" }}>
            <iframe
              title="map"
            ...
            />
            {/* decor */}
            <div className="absolute -top-1 left-0 right-0 opacity-90 pointer-events-none">
              <WaveTop />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-6">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl border bg-white" style={{ borderColor: "#EAD6C4" }}>
                <div className="font-semibold" style={{ color: "#2B2118" }}>
                  {b.t}
                </div>
                <ul className="mt-3 space-y-2 text-sm" style={{ color: "#4B3B30" }}>
      ...
      <section id="tech" className="py-14 md:py-20" style={{ backgroundColor: "#FFF3EA" }}>
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="p-6 rounded-2xl border shadow bg-white" style={{ borderColor: "#EAD6C4" }}>
            <div className="font-semibold flex items-center gap-2" style={{ color: "#2B2118" }}>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-3 text-sm" style={{ color: "#4B3B30" }}>
              {[
                ...
                "Удобные планировки",
                "Паркинг и коммерция на территории",
              ].map((t, i) => (
                <div key={i} className="p-4 rounded-xl border" style={{ backgroundColor: "#FFF8F2", borderColor: "#EAD6C4" }}>
                  {t}
                </div>
              ))}
            </div>
              ...
              <tbody style={{ color: "#4B3B30" }}>
                {[
                  ...
                  <tr key={i} className="border-t" style={{ borderColor: "#EAD6C4" }}>
                    <td className="px-4 py-3 font-medium" style={{ color: "#2B2118" }}>
                      {r.q}
                    </td>
      ...
      <section id="process" className="py-14 md:py-20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-6 grid md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="p-5 rounded-2xl border flex items-start gap-3 bg-white" style={{ borderColor: "#EAD6C4" }}>
                ...
                <div>
                  <div className="text-lg font-semibold" style={{ color: "#2B2118" }}>
                    {i + 1}. {s.t}
                  </div>
                  <div className="text-sm mt-1" style={{ color: "#4B3B30" }}>
                    {s.d}
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl border bg-[#FFF8F2]" style={{ borderColor: "#EAD6C4" }}>
              <div className="font-semibold flex items-center gap-2" style={{ color: "#2B2118" }}>
              ...
              <div className="grid grid-cols-3 gap-3 mt-3 text-sm" style={{ color: "#4B3B30" }}>
                {["Сбер", "ВТБ", "Дом.РФ", "Альфа", "Газпромбанк", "РНКБ"].map((b, i) => (
                  <div key={i} className="h-14 rounded-xl border grid place-items-center bg-white" style={{ borderColor: "#EAD6C4" }}>
                    {b}
                  </div>
                ))}
              </div>
              <p className="text-xs mt-3" style={{ color: "#7A6A5F" }}>
                Перечень банков может расширяться.
              </p>
            </div>

            <div className="p-6 rounded-2xl border shadow bg-white relative overflow-hidden" style={{ borderColor: "#EAD6C4" }}>
              <div className="font-semibold flex items-center gap-2" style={{ color: "#2B2118" }}>
                <Home size={18} /> Видео-тур по кварталу
              </div>
              <div className="mt-3 aspect-video rounded-xl overflow-hidden border relative" style={{ borderColor: "#EAD6C4" }}>
                <iframe
                  title="video"
      ...
      <section id="buy" className="py-20 relative">
        <div className="absolute inset-x-0 -top-16 opacity-90 pointer-events-none">
          <WaveTop />
        </div>
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-4">
            ...
            <p style={{ color: "#4B3B30" }}>
              Подберём планировки и условия под вашу задачу — проживание, аренда, инвестиция. Расскажем о доступных
              корпусах и сроках.
            </p>
            <a
              href="https://t.me/todayididg00d"
          ...
          <div id="cta" className="p-6 rounded-2xl border shadow bg-white" style={{ borderColor: "#EAD6C4" }}>
            {sent ? (
              <div className="text-center">
                <div className="text-xl font-semibold" style={{ color: "#2B2118" }}>
                  Спасибо! Заявка отправлена.
                </div>
                <p className="mt-2" style={{ color: "#4B3B30" }}>
...
function WaveTop() {
  return (
    <svg viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full h-[60px]">
      <path d="M0,40 C240,0 480,80 720,40 C960,0 1200,80 1440,40 L1440,60 L0,60 Z" fill="#FFF3EA"></path>
    </svg>
  );
}
function WaveBottom() {
  return (
    <svg viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full h-[60px] rotate-180">
      <path d="M0,40 C240,0 480,80 720,40 C960,0 1200,80 1440,40 L1440,60 L0,60 Z" fill="#FFF3EA"></path>
    </svg>
  );
}
function DecorWaves() {
  return (
    <div className="pointer-events-none absolute inset-0 -z-10">
      {/* лёгкие бегущие волны на фоне */}
      <svg className="absolute top-[-60px] left-0 w-full h-[120px]" viewBox="0 0 1440 120" preserveAspectRatio="none">
        <path d="M0,60 C300,20 540,100 720,60 C900,20 1140,100 1440,60 L1440,120 L0,120 Z" fill="#F6E6D9" />
      </svg>
      <svg className="absolute bottom-[-60px] left-0 w-full h-[120px]" viewBox="0 0 1440 120" preserveAspectRatio="none">
        <path d="M0,60 C300,20 540,100 720,60 C900,20 1140,100 1440,60 L1440,120 L0,120 Z" fill="#F6E6D9" />
      </svg>
    </div>
  );
